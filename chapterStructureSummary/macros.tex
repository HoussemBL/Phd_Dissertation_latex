...
\newcommand{\sub}{<:}
%\newcommand{\rec}[2]{{\texttt\bf\{}#1 , \ldots , #2\}}
...
\newcommand{\judbaseeEq}[2]{\vdash  #1  = #2}
...
\newcommand{\ft}{{\texttt \bf t}}
\newcommand{\fu}{{\texttt \bf u}}
\newcommand{\fv}{{\texttt \bf v}}
\newcommand{\fw}{{\texttt \bf w}}

\newcommand{\interp}[1]{{\texttt Perm}(#1)}
